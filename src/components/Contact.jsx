  ...
  return (
    <section id="contact" className="py-32 px-6 md:px-12 max-w-5xl mx-auto border-t border-surfaceBorder mb-10">
      ...
      >
        ...
        <a
          href="mailto:shreyashi2292@gmail.com"
        ...
        <div className="w-full pt-10 border-t border-surfaceBorder flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex space-x-8 text-muted font-mono text-sm uppercase tracking-widest">
            <a href="https://github.com/shreyashiijain" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">
              GitHub
            </a>
            <a href="https://linkedin.com/in/shreyashi-jain-9a81a4333" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">
              LinkedIn
            </a>
            <a href="tel:+919149231950" className="hover:text-white transition-colors">
              Call Me
            </a>
          </div>
        </div>
